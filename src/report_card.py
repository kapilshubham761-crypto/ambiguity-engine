"""
Report Card — periodic assessment of the semantic graph's cognitive health.

Runs every 3-6 hours (called by Teacher.check_in()).
...
# --------------------------------------------------------------------------- #
# Stage expectations (min nodes to be "on track" at each stage)               #
# --------------------------------------------------------------------------- #
STAGE_TARGETS = {
